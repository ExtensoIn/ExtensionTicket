...
function Home() {
    const eventsQuery = useQuery({
        queryKey: ['allEvents'],
        queryFn: () => getEvents(6, 0, undefined),
...
function CreateEvent() {
    ...
    return (
        <section
            className='font-DMSans bg-purple-200 w-full flex flex-col gap-4 md:gap-10 justify-center items-center px-6 pb-6 md:max-h-64 md:flex-row'>
