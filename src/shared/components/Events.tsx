    ...
    return (
        <div className='relative af'>
            <div className='bg-transparent w-full top-[-3.75rem] flex absolute z-20 items-center justify-center px-10 md:px-20 lg:px-40'>
                <div className='bg-blue-950 w-full z-10 rounded-2xl flex gap-8 justify-center p-6 pt-2 xs:p-10 xs:pt-6'>
            ...
            <section className='flex flex-col items-center justify-center bg-gray-100 px-10 py-24 md:px-20 lg:px-40 md:py-28'>
